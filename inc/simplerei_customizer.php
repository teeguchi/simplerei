...
function simplerei_customize_css() {
	...
	if ( get_theme_mod( 'text_color', '#333333' ) !== '#333333' ) {
		...
		$simplerei_style .= 'body, form input[type="submit"], .footer-widget form input[type="submit"], .footer-widget .widget select, .footer-widget .widget a, .footer-widget .widget .search-submit {color:' . $text_color . ';} .footer-widget .widget select, .footer-widget .widget .search-field, .footer-widget form textarea, .footer-widget form input[type="text"], .footer-widget form input[type="email"], .footer-widget form input[type="url"], .footer-widget form input[type="password"], .footer-widget form input[type="submit"] {border-color:' . $text_color . ';} ';
	}
